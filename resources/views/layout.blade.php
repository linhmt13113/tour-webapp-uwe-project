       ...
       <div class="container-fluid">
          <div class="slider-wrapper theme-default">
             <div id="slider-master" class="nivoSlider">
                <a href=""><img src="{{ asset('frontend/images/bai-dinh-trang-an.jpg') }}" data-thumb="{{ asset('frontend/images/bai-dinh-trang-an.jpg') }}" alt="aa" title="" /></a>
                <a href=""><img src="{{ asset('frontend/images/phu-quoc-hon-mong-tay-vietnam-travel.jpg') }}" data-thumb="{{ asset('frontend/images/phu-quoc-hon-mong-tay-vietnam-travel.jpg') }}" alt="aa" title="" /></a>
             </div>
          </div>
       </div>
