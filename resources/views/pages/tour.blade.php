    ...
    <div class="row">
       <div class="col-md-12 col-xs-12 bx-title-lst-tour text-center">
          <div class="w100 fl title-tour1">
             <h2 style="color: #ffc700;font-size: 30px;" ><img src="https://vietnamtravel.net.vn/assets/desktop/images/icon_mb.png" alt="icon" style="width: 80px;">Danh muc: Tour Giá Sốc</h2>
          </div>
       </div>
            ...
            <div class="col-md-4 col-xs-12 lst-tour-item">
                <div class="w100 fl bx-wap-pr-item">
                   <div class="clearfix box-wap-imgpr">
                      <a href="{{ route('detail-tour', ['du-lich-quy-nhon']) }}">
                   ...
                   <div class="clear"></div>
                   <h4><a href="{{ route('detail-tour', ['du-lich-quy-nhon']) }}">Tour Hot nhất Hè 2023 Quy Nhơn - Phú Yên (Xứ Nẫu đẹp nhất Việt Nam)</a></h4>
                   <div class="clear"></div>
                   ...
                   <div class="group-book w100 fl">
                      ...
                      <a href="{{ route('detail-tour', ['du-lich-quy-nhon']) }}" class="link-book btn_view_tour0">Xem chi tiết</a>
                   </div>
                </div>
             </div>
